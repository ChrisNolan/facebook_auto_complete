/**
originally written by tyson malchow for the Rate Me facebook application
posted @ http://wiki.developers.facebook.com/index.php/FBJS/Examples/Typeahead/AJAX
this version maintained @ http://github.com/ChrisNolan/facebook_auto_complete/
 **/
...
options = {
  ...
  onEnter: function(event) {    // handler for hitting the 'enter' key
    alert('they hit enter!');  // alert doesnt' work on FBJS btw
  },
